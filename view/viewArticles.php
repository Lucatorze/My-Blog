...
<section>
    ...
    <div class="viewArticleConteneur">
        ...
        if(isset($_SESSION['userId']) && $getViewArticles['idAuthor'] == $_SESSION['userId'] || isset($_SESSION['admin'])){

            echo '<a class="linkViewArticle" href="index.php?pages=newArticles&&updateArticles=' . $getViewArticles['id'] . '">Modifier</a>';
            echo '<a class="linkViewArticle" href="index.php?pages=viewArticles&&deleteArticles=' . $getViewArticles['id'] . '">Supprimer</a>';
    ...
    <div class="viewComment">
        <br><br><img class="imageFlech" src="./assets/img/flech.png" title="voir les commentaires">
    ...
    <div>
        ...
        <?php foreach($getCommentsOrder as $result):?>
            ...
            <div class="comment">
                ...
                if(isset($_SESSION['userId']) && $result['idAuthor'] == $_SESSION['userId'] || isset($_SESSION['admin'])){
