...
<body>
    <main role="main">
      <header>
        ...
        <form id="registerForm" name="registerForm" method="post" action="registerController.php" > <!--supp pour ajax :registerController.php-->
    ...
    $('form').submit(function (){
      $.ajax({
          ...
          success : function(data){
            var toPrint = 'firstname : '+data.user.firstname+'<br>';
                toPrint += 'lastname : '+data.user.lastname+'<br>';
                toPrint += 'nickname : '+data.user.nickname+'<br>';
